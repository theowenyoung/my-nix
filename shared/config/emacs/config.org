...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Owen Young"
    user-mail-address "theowenyoung@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/green/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/green/bin" "/profile/bin" "/Users/green/.npm-packages/bin" "/Users/green/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
